...
void main() {
  ...
  late String encryptedStringByUser0, encryptedStringByUser0AfterKr, encryptedStringByUser0WithSign, encryptedStringByUser0AfterKr1;
  ...
  group("child group", () {
    ...
    testWidgets("invite user manually with prepare to child group", (widgetTester) async {
      ...
      final res = await http.put(
        Uri.parse(url),
        body: invite,
        headers: {"Accept": "application/json", "Content-Type": "application/json", "Authorization": "Bearer $jwt", "x-sentc-app-token": "5zMb6zs3dEM62n+FxjBilFPp+j9e7YUFA+7pi6Hi"},
      );
  ...
  group("key rotation with sign", () {
    ...
    testWidgets("finish the key rotation for the 2nd user with verify", (widgetTester) async {
      ...
      await groupForUser1.finishKeyRotation(1);
